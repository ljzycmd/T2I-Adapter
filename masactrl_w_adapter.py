        ...
        for test_idx, cond_path in enumerate(image_paths):
            ...
            for v_idx in range(opt.n_samples):
                ...
                if opt.src_img_path:  # perform ddim inversion
                    ...
                    torch.save(
                        {
                            ...
                            "latents_list": latents_dict["x_inter"],
                        },
                        os.path.join(opt.outdir, "start_code.pth"),
                    )
                    if opt.use_ddim_latents:
                        ref_latents = latents_dict["x_inter"]
                    ...
                    if opt.use_ddim_latents:
                        ref_latents = start_code_dict.get("latents_list")
                else:
